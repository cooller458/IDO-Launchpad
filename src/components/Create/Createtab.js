...
import { ONEDAYINSECONDS, CHAINS } from '../../config/env'
...
class Createtab extends Component
{
    ...
    goToSale(){
        window.location.href = `${window.location.origin}/sale/${this.state.createdSale}`;
    }
      ...
      return (
        ...
        <p className='mb-0'>
           ...
           <span>{this.state.symbol=='' ? 'Token Symbol': this.state.symbol}</span>
                    ...
                    <div className="inputs input-groups">
                        <InputGroup className="">
                            <FormControl value={this.state.address} onChange={(e)=> {this.setState({ address: e.target.value });this.getTokenInfo(e.target.value);} } id="tokenaddress" placeholder=""
                                aria-describedby="basic-addon2"
                            />
    ...
    <div className='row'>
        <div className='col-12 col-md-12'>
                      <p className='yellow_txt font_20 mb-4 toggle_label'>Vesting
       ...
       <input type="checkbox"  checked={this.state.isVested} onChange={(e)=> this.setState({isVested : e.target.checked})}/>
       <span className="slider round"></span>
          ...
          {this.state.isVested ? 
             <>   <div className='col-12 col-md-6 mb-3'>
                    ...
                    <div className="inputs input-groups">
                        <InputGroup className="">
                            <FormControl value={this.state.vestPercent} onChange={(e)=>{if(!isFloat(e.target.value)){ this.setState({ vestPercent: e.target.value }) }} } id="vestingliquidityrate" placeholder=""
                                aria-describedby="basic-addon2"
                            />
        ...
        <div className='row'>
                      <div className='col-12 col-md-12'>
                      <p className='yellow_txt font_20 mb-2 toggle_label'>Liquidity
                      <span className="font_14 yelow_desc_blk swithch_inline">
                      <div className="inputs inputs_switdch input-groups">
       ...
       <input type="checkbox" checked={this.state.isPancake} onChange={(e)=> this.setState({isPancake : e.target.checked})}/>
       <span className="slider round"></span>
       </label>
            ...
            <div className='col-12 col-md-6 mb-3'>
                    ...
                    <div className="inputs input-groups">
                        <InputGroup className="">
                            <FormControl id="liquiditylockingdays" value={this.state.unlockOn} onChange={(e)=>this.setState({ unlockOn: e.target.value }) } placeholder=""
                                aria-describedby="basic-addon2"
                            />
                        ...
                        <div className='col-12 col-md-6 mb-3'>
                    <p className='input_desc_sm'>Liquidity Rate per BNB</p>
                    <div className="inputs input-groups">
                        <InputGroup className="">
                            <FormControl pattern="/^\d+$/" id="liquidityliquidityrate" value={this.state.pancakeRate} onChange={(e)=>{if(!isFloat(e.target.value)){  this.setState({ pancakeRate: e.target.value }) }}} placeholder=""
                                aria-describedby="basic-addon2"
                            />
            ...
            { this.state.isPancake ?
                <>
                 ...
                 <div className='col-12 col-md-12 mb-3'>
                        ...
                        <div className="inputs input-groups">
                            <InputGroup className="">
                                <FormControl pattern="/^\d+$/" id="pancakswapliquidity" value={this.state.liquidityPercent} onChange={(e)=>{if(!isFloat(e.target.value)){ this.setState({ liquidityPercent: e.target.value }) }}} placeholder=""
                                    aria-describedby="basic-addon2"
                                />
...
<>
       ...
       <span className="slider round"></span>
                        ...
                        <div className='col-12 text-right mt-4'>
                          ...
                          <p className='yellow_txt font_20 m-lg-0 text-yellow toggle_label'>Create&nbsp;=&gt;&nbsp;Calculate&nbsp;=&gt;&nbsp;Deposit&nbsp;=&gt;&nbsp;Proceed To Sale</p>
                        { !this.state.isDeposited ? 
                        (this.state.createdSale == '' ?
                        <a onClick={this.CreateSale.bind(this)} className="get-started-btn-fill">Create</a>:
                        this.renderDeposit()): <a onClick={this.goToSale.bind(this)} className="get-started-btn-fill">Proceed to Sale</a>
                        }
                          </div>
                        </div>
                      </div>
